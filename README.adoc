...
image:https://github.com/vrza/array-with-secondary-keys/actions/workflows/unit-tests.yml/badge.svg[Build Status (GitHub Actions),link=https://github.com/vrza/array-with-secondary-keys/actions]
